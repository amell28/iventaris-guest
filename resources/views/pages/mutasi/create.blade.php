        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center mb-50">
                    <h2>Formulir Mutasi Aset</h2>
                    <p>Catat perubahan status, pemindahan, atau penghapusan aset.</p>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow-lg border-0 rounded-3">
                    ...
                    <div class="card-header bg-primary text-white p-4 rounded-top-3">
                        <h4 class="card-title mb-0">
                            <i class="bi bi-arrow-left-right me-2"></i> Tambah Mutasi Aset
                        </h4>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="jenis_mutasi" class="form-select" required>
                                            ...
                                            <option value="Pemindahan" {{ old('jenis_mutasi') == 'Pemindahan' ? 'selected' : '' }}>
                                                Pemindahan
                                            </option>
                                            <option value="Penghapusan" {{ old('jenis_mutasi') == 'Penghapusan' ? 'selected' : '' }}>
                                                Penghapusan
                                            </option>
                                        </select>
                                    </div>
